  ...
  transform: translateY(-50%); font-size: 1rem; padding-left: 0.75rem; color: transparent; font-weight: 400; font-family: 'Roboto', 'Helvetica', 'Arial', sans-serif; padding-left: 0.75rem">{{ SoTienChuyen2 }}.</div>
              ...
              <div class="md-layout-item md-small-size-100 md-size-100" style="margin-bottom: 1rem">
                <div class="row">
                  ...
                  <div class="col-sm-10">
                    <b-form-textarea id="NoiDungChuyenTienInternal" v-model="NoiDungChuyenTien" placeholder="Nhập nội dung nhắc nợ..." rows="3" max-rows="6" required></b-form-textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="md-layout-item md-size-100 text-left"  style="margin-bottom: 1rem">
            ...
            <b-button variant="secondary" @click="handleQuayLai">Quay lại</b-button>
          </div>
          <div class="md-layout-item md-small-size-100 md-size-100">
            <br>
          </div>
